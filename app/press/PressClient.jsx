...
const COVERAGE = [
  {
    outlet: 'Vogue India',
    date: 'March 2026',
    title: '"The Indian skincare brand that\'s rewriting the rules of clean beauty"',
    logo: 'V',
  },
  {
    outlet: 'Forbes India',
    date: 'January 2026',
    title: '"50 startups to watch in 2026 — VerdeBliss leads the organic beauty wave"',
    logo: 'F',
  },
  {
    outlet: 'The Hindu',
    date: 'November 2025',
    title: '"From Pune kitchen to global shelves: the VerdeBliss story"',
    logo: 'TH',
  },
  {
    outlet: 'Femina',
    date: 'October 2025',
    title: '"Best Organic Serum 2025 — Bakuchiol Renewal Serum wins Gold"',
    logo: 'Fe',
  },
  {
    outlet: 'Business Standard',
    date: 'August 2025',
    title: '"VerdeBliss crosses ₹10 crore ARR on 100% organic growth"',
    logo: 'BS',
  },
  {
    outlet: 'Mint Lounge',
    date: 'June 2025',
    title: '"The science behind India\'s best-selling plant-based retinol alternative"',
    logo: 'M',
  },
]
    ...
    <div style={{ background: C.bg }}>
      ...
      >
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          >
            For press enquiries, interview requests, and brand assets, contact us at
            press@verdebliss.in
          </p>
          <button
            onClick={() =>
              toast('Press kit download coming soon! Email press@verdebliss.in', 'info')
            }
            style={{
              background: C.terra,
              color: 'white',
        ...
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          {AWARDS.map((a, i) => (
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 15, color: C.text, fontWeight: 500, marginBottom: 4 }}>
                  {a.award}
                </div>
                <span
                  style={{
