    ...
    <div style={{ background: C.bg }}>
      ...
      <section style={{ maxWidth:1200, margin:'0 auto', padding:'80px 16px' }}>
        ...
        <div style={{ textAlign:'center', marginTop:40 }}>
          <button onClick={() => router.push('/products')} style={{ background:'none', border:`2px solid ${C.forest}`, color:C.forest, borderRadius:10, padding:'12px 32px', fontSize:14, fontWeight:600, cursor:'pointer', fontFamily:'inherit', display:'inline-flex', alignItems:'center', gap:8 }}>
