...
const ARTICLES = [
  {
    ...
    excerpt:
      'Retinol has ruled anti-ageing for decades. But bakuchiol — the plant-based alternative — is changing everything. We break down the science, the differences, and which one wins for sensitive skin.',
  ...
  },
  {
    ...
    excerpt:
      "Dry skin needs more than just a heavy cream. The right layering order, the right ingredients, and the right timing make all the difference. Here's the dermatologist-approved organic routine.",
  ...
  },
  {
    ...
    excerpt:
      'Indian skin faces unique challenges — humidity, pollution, UV intensity. Discover why certified organic formulations outperform conventional alternatives and how to read ingredient labels like an expert.',
    category: 'Education',
    readTime: 7,
    ...
    <div style={{ background: C.bg, minHeight: '100vh' }}>
      ...
      <div style={{ background: C.forest, padding: '64px 16px 48px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          ...
          >
            Ingredient science, skin rituals, and expert guides — because educated skin is healthy
            skin.
          </p>
        </div>
      </div>
