...
const PILLARS = [
  {
    ...
    body: 'Every botanical is sourced from certified organic farms with fair-trade agreements. We visit our suppliers annually and publish audit reports.',
  },
  {
    icon: '♻️',
    title: 'Circular Packaging',
    body: "Glass bottles, aluminium caps, and paper labels. Our packaging is 92% recyclable or refillable. We're targeting 100% by 2027.",
  },
  {
    icon: '💧',
    title: 'Water Stewardship',
    body: 'Our Pune lab uses a closed-loop water system that recycles 84% of process water. We offset the remainder via local watershed projects.',
  },
  {
    icon: '🌍',
    title: 'Carbon Neutral by 2027',
    body: "We've reduced scope 1+2 emissions by 41% since 2022. Remaining emissions are offset via verified reforestation in the Western Ghats.",
  },
  {
    icon: '🐝',
    title: 'Biodiversity Commitment',
    body: 'We partner with 12 organic farms that maintain pollinator corridors. For every product sold, ₹5 goes to a native seed-bank programme.',
  },
  {
    icon: '👩‍🌾',
    title: 'Farmer Partnerships',
    body: 'Our 34 farming partners receive 23% above fair-trade price benchmarks. We provide interest-free equipment loans and organic certification support.',
  },
]
...
export default function SustainabilityClient() {
  return (
    <div style={{ background: C.bg }}>
      ...
      <section
        style={{
          background: `linear-gradient(150deg, #1A3320 0%, ${C.forest} 100%)`,
      ...
      >
        ...
        >
          ...
          >
            Our commitment to the planet is not a marketing message. It is written into every
            formula, every package, and every supply-chain decision we make.
          </p>
        </motion.div>
      </section>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 24px' }}>
        <div style={{ textAlign: 'center', marginBottom: 52 }}>
          ...
          <h2 style={{ fontFamily: FONT.serif, fontSize: 44, color: C.text, fontWeight: 400 }}>
            Six pillars of responsibility
          </h2>
        </div>
        <div
          style={{
