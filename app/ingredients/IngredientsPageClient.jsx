...
const PRINCIPLES = [
  {
    title: 'No Parabens',
    desc: 'We never use parabens as preservatives. Our formulas use plant-derived alternatives.',
  },
  {
    title: 'No Sulfates',
    desc: 'Sodium lauryl sulfate strips your skin barrier. Our cleansers never use it.',
  },
  {
    title: 'No Synthetic Fragrance',
    desc: 'All scent comes from the botanicals themselves — never synthetic perfume compounds.',
  },
  {
    title: 'No Mineral Oil',
    desc: 'We use plant-based oils that nourish, not petroleum-derived mineral oil that clogs.',
  },
  {
    title: 'No Formaldehyde Releasers',
    desc: 'Zero DMDM hydantoin or diazolidinyl urea — known irritants we refuse to touch.',
  },
  {
    title: 'No Animal Testing',
    desc: 'VerdeBliss has never and will never conduct or commission animal testing.',
  },
]
    ...
    <div style={{ background: C.bg }}>
      ...
      >
        ...
        >
          ...
          >
            Every ingredient has a story. We believe you deserve to know exactly what you&apos;re
            putting on your skin and why.
          </p>
        </motion.div>
      </section>
              ...
              */}
              ...
              >
                ...
                <div style={{ padding: '16px 20px 22px', borderTop: `1px solid ${C.border}` }}>
                  ...
                  <div
                    style={{ fontSize: 12, color: C.terra, fontStyle: 'italic', marginBottom: 12 }}
                  >
                    {ing.source}
                  </div>
      ...
      <section style={{ padding: '72px 24px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 15, color: C.muted, marginBottom: 28 }}>
          Every VerdeBliss product is built around one or more of these certified organic actives.
        </p>
        <button
