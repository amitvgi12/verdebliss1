              ...
              {CATEGORIES.map((c) => (
                <button
                  ...
                  style={{
                    ...
                    padding: '7px 10px',
                    fontSize: 13,
                    color: category === c ? C.forest : C.muted,
                    fontWeight: category === c ? 600 : 400,
                    cursor: 'pointer',
                    borderLeft: category === c ? `2px solid ${C.forest}` : '2px solid transparent',
                    borderRadius: '0 6px 6px 0',
                    background: category === c ? C.sagePale : 'none',
                    fontFamily: 'inherit',
              ...
              {SKIN_TYPES.map((s) => (
                <button
                  ...
                  style={{
                    ...
                    padding: '7px 10px',
                    fontSize: 13,
                    color: skinType === s ? C.terra : C.muted,
                    fontWeight: skinType === s ? 600 : 400,
                    cursor: 'pointer',
                    borderLeft: skinType === s ? `2px solid ${C.terra}` : '2px solid transparent',
                    borderRadius: '0 6px 6px 0',
                    background: skinType === s ? C.terraPale : 'none',
                    fontFamily: 'inherit',
                    transition: 'all 0.15s',
                  }}
                >
          ...
          <div style={{ marginTop: 24 }}>
              ...
              <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                {SORT_OPTIONS.map((s) => (
                  <button
                    ...
                    style={{
                      background: sortBy === s ? C.forest : C.ivory,
                      color: sortBy === s ? 'white' : C.muted,
                      border: `1px solid ${sortBy === s ? C.forest : C.border}`,
                      borderRadius: 8,
                      padding: '6px 10px',
                      fontSize: 11,
                      cursor: 'pointer',
            ...
            {!loading && products.length === 0 && (
              <div style={{ textAlign: 'center', padding: '80px 0' }}>
                ...
                <div style={{ fontSize: 20, color: C.muted, fontFamily: FONT.serif }}>
