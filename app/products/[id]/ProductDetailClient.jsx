...
export default function ProductDetailClient({ id, initialProduct }) {
  ...
  if (!p) return (
    <div style={{ minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16, padding: '0 24px' }}>
      ...
      <button onClick={() => router.push('/products')} style={{ background: C.forest, color: 'white', border: 'none', borderRadius: 10, padding: '10px 24px', fontSize: 13, cursor: 'pointer', fontFamily: 'inherit', fontWeight: 600 }}>Back to Shop</button>
    </div>
  )
  ...
  return (
    <div style={{ background: C.bg, minHeight: '100vh' }}>
      ...
      <div style={{ borderBottom: `1px solid ${C.border}`, background: C.bg, overflowX: 'hidden' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: outerPad }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 4, height: 40, fontSize: 12, color: C.muted, overflow: 'hidden' }}>
            <button onClick={() => router.push('/')} style={crumbBtn}>Home</button>
            <ChevronRight size={11} style={{ flexShrink: 0 }} />
            <button onClick={() => router.push('/products')} style={crumbBtn}>Shop</button>
            <ChevronRight size={11} style={{ flexShrink: 0 }} />
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: sectionPad }}>
        <button onClick={() => router.push('/products')} style={{ background: 'none', border: 'none', color: C.muted, fontSize: 12, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 5, fontFamily: 'inherit', fontWeight: 500, marginBottom: isMobile ? 16 : 28, padding: 0 }}>
