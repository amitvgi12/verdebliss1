    ...
    <div style={{ background: C.bg }}>
      ...
      >
        ...
        >
          ...
          >
            Born from a personal skin struggle. Built on botanical science. Committed forever to the
            earth that feeds us.
          </p>
        </motion.div>
      </section>
      ...
      {/* Mission statement */}
      <section
        style={{ maxWidth: 800, margin: '0 auto', padding: '80px 24px', textAlign: 'center' }}
      >
        <div
          style={{
            fontSize: 10,
        ...
        >
          &ldquo;To prove that the most effective skincare is also the kindest — to your skin, to
          animals, and to the planet.&rdquo;
        </p>
      ...
      <section style={{ background: C.forest, padding: '72px 24px', textAlign: 'center' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', marginBottom: 32, fontSize: 16 }}>
          Every product tells the story of a seed, a soil, and a scientist who cares.
        </p>
        <button
