  ...
  return (
    <div style={{ background: C.bg }}>
      ...
      <section style={{ background: C.forest, padding: '72px 24px', textAlign: 'center' }}>
        ...
        <button onClick={() => router.push('/products')} style={{ background: C.terra, color: 'white', border: 'none', borderRadius: 10, padding: '14px 32px', fontSize: 15, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
