...
export default function Footer() {
  ...
  return (
    <>
      ...
      <footer
        style={{ background: C.forest, color: 'rgba(255,255,255,0.55)', padding: '56px 16px 28px' }}
      >
        <div
          style={{
            maxWidth: 1200,
        ...
        >
          ...
          <div>
            ...
            >
              ...
              */}
              ...
              <span style={{ display: 'none', alignItems: 'center', gap: 6, marginTop: 4 }}>
                ...
                <span style={{ fontFamily: FONT.serif, fontSize: 18, color: 'white' }}>
                  VerdeBliss
                </span>
              </span>
            </button>
            ...
            <div style={{ fontSize: 11, color: C.sage, fontWeight: 600, marginBottom: 16 }}>
              📩 hello@verdebliss.in
            </div>
