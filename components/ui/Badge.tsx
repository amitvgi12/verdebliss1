...
const BADGE_STYLES: Record<string, { bg: string; color: string }> = {
  'Vegan-friendly · evidence review': { bg: '#EBF0E9', color: '#1E5C28' },
  'No animal testing · audit underway': { bg: '#F6EDE8', color: '#7A2A0A' },
  'Organic botanicals · evidence review': { bg: '#FFF5E4', color: '#664A08' },
}
