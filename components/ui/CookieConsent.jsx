        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 12 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p
                id="cookie-desc"
                style={{ fontSize: 12, color: C.muted, lineHeight: 1.6, margin: 0 }}
              >
                We use essential cookies to keep this site working. With your consent we also use
                analytics cookies to improve your experience. We do not use advertising tracking
                cookies. Read our{' '}
                <button
                  onClick={() => {}}
                  style={{
                ...
                >
                  ...
                  >
                    <input
                      ...
                      readOnly
                      disabled
                      style={{ marginTop: 3, accentColor: C.forest }}
                    />
                    <div>
                      <span style={{ fontSize: 12, fontWeight: 600, color: C.text }}>
                        Essential Cookies
                      </span>
                      <span style={{ fontSize: 10, color: C.gold, marginLeft: 6, fontWeight: 600 }}>
                        Always Active
                      </span>
                      <p
                        style={{ fontSize: 11, color: C.muted, margin: '2px 0 0', lineHeight: 1.5 }}
                      >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p
                        style={{ fontSize: 11, color: C.muted, margin: '2px 0 0', lineHeight: 1.5 }}
                      >
                        Help us understand how visitors use the site so we can improve it. No
