-- ─────────────────────────────────────────────────────────────
-- Migration: initial schema (full idempotent baseline)
-- Source:    supabase/schema.sql
-- Applied:   2025-01-01 (baseline)
-- ─────────────────────────────────────────────────────────────
...
begin
  ...
  if product_id_type in ('text', 'character varying') then
    ...
    ('5', 'botanical-spf-50-shield', 'Botanical Mineral Sun Shield', 'Mineral daily sun-care shield with zinc oxide and soothing aloe vera. SPF-rating evidence is in review.', 220, null, null, 'SPF', array['All Types'], array['Vegan-Friendly','Cruelty-free*'], 'Zinc Oxide', '☀️', '#FFF8E8', '/images/products/spf.webp', null, 0, 100, array[]::text[]),
