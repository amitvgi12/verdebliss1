...
begin
  ...
  if product_id_type in ('text', 'character varying') then
    ...
    ('1', 'bakuchiol-renewal-serum', 'Bakuchiol Renewal Serum', 'Plant-based retinol alternative for visible cell renewal without irritation.', 250, null, null, 'Serum', array['Dry','Combination'], array['Vegan-Friendly','Organic Botanicals'], 'Bakuchiol', '🌿', '#EBF0E9', '/images/products/serum.webp', null, 0, 100, array[]::text[]),
    ...
    ('4', 'turmeric-brightening-cleanser', 'Turmeric Brightening Cleanser', 'Gentle foam cleanser with turmeric and neem for a luminous complexion.', 250, null, null, 'Cleanser', array['All Types'], array['Cruelty-free*','Organic Botanicals'], 'Turmeric', '✨', '#F5F0E4', '/images/products/cleanser.webp', null, 0, 100, array[]::text[]),
    ('5', 'botanical-spf-50-shield', 'Botanical SPF 50 Shield', 'Featherlight mineral sunscreen with zinc oxide and soothing aloe vera.', 220, null, null, 'SPF', array['All Types'], array['Vegan-Friendly','Cruelty-free*'], 'Zinc Oxide', '☀️', '#FFF8E8', '/images/products/spf.webp', null, 0, 100, array[]::text[]),
    ('6', 'wild-berry-lip-elixir', 'Wild Berry Lip Elixir', 'Nourishing lip treatment with acai berry and shea for pillowy softness.', 490, null, null, 'Lip Care', array['All Types'], array['Organic Botanicals'], 'Acai Berry', '🫐', '#F0E8F5', '/images/products/lip-elixir.webp', null, 0, 100, array[]::text[]),
    ('7', 'niacinamide-pore-serum', 'Niacinamide Pore Serum', 'Minimise pores and control sebum with a 10% niacinamide complex.', 350, null, null, 'Serum', array['Oily','Combination'], array['Vegan-Friendly','Cruelty-free*'], 'Niacinamide', '💧', '#E8EFF5', '/images/products/niacinamide-serum.webp', null, 0, 100, array[]::text[]),
    ('8', 'shea-butter-night-cream', 'Shea Butter Night Cream', 'Intensive overnight repair with shea butter and vitamin E for morning glow.', 550, null, null, 'Moisturiser', array['Dry','Sensitive'], array['Organic Botanicals','Cruelty-free*'], 'Shea Butter', '🌙', '#F5EBF0', '/images/products/night-cream.webp', null, 0, 100, array[]::text[])
